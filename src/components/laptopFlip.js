...
import "../customStyles/laptopFlip.css";

export default function LaptopFlip() {
  return (
    <>
      <a
        class="bear-link"
                        ...
                        <div class="scene__flip">
                          <div class="jbook">
                            <div class="jbook__shell shell shell--top">
                             {/* We can put text here inside the screen */}
                              <div class="cuboid">
